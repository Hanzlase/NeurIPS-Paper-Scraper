...
MAX_WORKERS = 5  # Reduce if hitting rate limits
API_DELAY = 0.1  # Short delay between requests
        ...
        with ThreadPoolExecutor(max_workers=MAX_WORKERS) as executor:
            ...
            for future in as_completed(futures):
                ...
                try:
                    ...
                    domain = rule_based_classify(title, df.iloc[index]['abstract'])
                    df.at[index, 'domain'] = domain
